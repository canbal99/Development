...
${OBJECTDIR}/_ext/ea2d4e53/strongly_connected.o: ../Course03_Algorithms_on_Graph/week02_Decomposition_of_Graphs/graph_decomposition_starter_files_2/strongly_connected/strongly_connected.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/ea2d4e53/strongly_connected.o ../Course03_Algorithms_on_Graph/week02_Decomposition_of_Graphs/graph_decomposition_starter_files_2/strongly_connected/strongly_connected.cpp
